package com.yzg.study.security.config;
...
public class JwtTokenEnhancer implements TokenEnhancer {
    ...
    public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        JSONObject jsonObject = new JSONObject((String) authentication.getPrincipal());
        List<Object> authorities = jsonObject.getJSONArray("authorities");
        ...
        additionalInfo.put("author", "GAOXINQIMENG");
